...
internal record SourceGenerationToggleWrappedValue<TValue>(
    ISourceGenerationToggle SourceGenerationToggle,
    TValue Value);
...
internal static class SourceGenerationToggleCombinerExtension
{
        ...
        IncrementalValueProvider<ISourceGenerationToggle> sourceGenerationToggleProvider)
    {
        return provider
            ...
            .Select((data, _) => 
                new SourceGenerationToggleWrappedValue<TValue>(data.Right, data.Left));
    }
