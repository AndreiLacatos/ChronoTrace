...
namespace ChronoTrace.SourceGenerators.Analyzers
{
    ...
    public sealed class InternalApiUsageGuard : DiagnosticAnalyzer
    {
        ...
        public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics => new List<DiagnosticDescriptor> { Rule }.ToImmutableArray();
        ...
        private static string GetDisplayNameForSymbol(ISymbol symbol)
        {
            ...
            if (symbol.ContainingType != null && !(symbol is INamedTypeSymbol))
            {
