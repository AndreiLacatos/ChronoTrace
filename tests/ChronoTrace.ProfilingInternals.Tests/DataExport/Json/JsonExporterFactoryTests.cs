...
public class JsonExporterFactoryTests
{
    ...
    /// </summary>
    [Fact]
    public void Complete_WhenCalledInSequence_CreatesCorrectJsonFileOnDiskAtDesiredLocationAndDesiredFile()
    {
        // Arrange
    ...
    /// </summary>
    [Fact]
    public void Complete_WhenCalledInSequence_CreatesCorrectJsonFileOnDiskAtDesiredLocationDefaultFile()
    {
        // Arrange
        var tempDirectory = Path.Combine(Path.GetTempPath(), $"ChronoTraceTests_{Guid.NewGuid()}");
